...
| <a name="input_volumes"></a> [volumes](#input_volumes)                                                                            | A list of volumes (secret, empty_dir, gcs, etc) to make available to containers.   | `list(object)` | `[]`                    |    no    |
| <a name="input_volume_mounts"></a> [volume_mounts](#input_volume_mounts)                                                          | A list of volume mounts (name, mount_path) to mount in the container.              | `list(object)` | `[]`                    |    no    |
